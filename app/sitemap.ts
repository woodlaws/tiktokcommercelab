...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPaths = [...new Set(['', 'insights', 'tiktok-shop-korea', 'seller-academy', 'free-class', 'live-agency', 'brand-growth', 'cases', 'contact', 'privacy', 'terms', ...Object.keys(pageContent)])];
